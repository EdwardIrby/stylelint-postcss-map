...
var checkExceptions = function checkExceptions(prop, value, options) {
  var exceptions = options.hasOwnProperty(prop) ? defaultExceptions.concat(options[prop]) : defaultExceptions;
  return exceptions.includes(value);
};

var checkValue = function checkValue(prop, value, options) {
